...
<body>
    ...
    <div class="row-fluid">
                ...
                <form action="">
               <div id="formfields">
                Name of Shop:<input type="text" id="NameOfShop" name="NameOfShop"/><br />
                Owner Name:<input type="text" id="OwnerName" name="OwnerName"/><br />
  Shop Email:<input type="email" id="email" name="email"/><br />
